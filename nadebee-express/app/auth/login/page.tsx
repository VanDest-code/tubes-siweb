    ...
    <main className="min-h-screen bg-[#F0FDF4] flex flex-col items-center relative font-poppins">
      ...
      <div className="flex flex-col items-center px-6 py-10 md:py-12 w-full max-w-md">
        ...
        <div className="w-full space-y-4">
          {/* Card Pelanggan */}
          <Link href="/auth/login/Pelanggan" className="block bg-white p-5 md:p-6 rounded-[28px] shadow-sm border-2 border-transparent hover:border-nadebee-primary transition-all active:scale-[0.98]">

...
export default function LoginKurir() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // Validasi Kode Kurir (Contoh: Harus 6 digit angka sesuai placeholder 232424)
    if (!kurirCode) {
  ...
  return (
    <main className="min-h-screen bg-nadebee-green flex flex-col items-center px-6 py-12 relative">
